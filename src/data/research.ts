...
export const researchHighlights: ResearchHighlight[] = [
  {
    ...
    links: [
      { label: 'HC Leaflet (日本語)', href: '/FY19Q1/hc_leaflet_fy19q1.pdf' },
      { label: 'HC Leaflet (English)', href: '/FY19Q1/tonoi-HC_leaflet_r7.5-eng.pdf' }
    ],
  ...
  },
  {
    ...
    summary:
      '情報処理学会アーキテクチャ研究会にてHybrid Computingに関する研究成果を発表。プラットフォーム設計や応用事例を多数公開しています。',
    links: [
      { label: 'ARC19235 発表資料', href: '/FY19Q1/2019ARC227/IPSJ-ARC19235.htm' },
      { label: '論文 PDF 一覧', href: '/FY19Q1/2019ARC227/IPSJ-ARC19235001.pdf' }
    ],
  ...
  },
  {
    ...
    summary:
      '世界規模での大規模計算に向けたHybrid Computingの可能性を紹介。高性能計算とデータ管理の両立に焦点をあてました。',
    links: [{ label: '発表スライド', href: '/BPCC18/tonoi-bpcc-public.pdf' }],
